...
using JobInTown.Azure.BackEnd.Providers;
using JobInTown.Azure.BackEnd.Results;
...
namespace JobInTown.Azure.BackEnd.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        // POST api/Account/ChangeImageUrl
        [Route("ChangeImageUrl")]
        public async Task<IHttpActionResult> ChangeImageUrl(ChangeImageUrlBindingModel model)
        {
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            ApplicationUser user = await UserManager.FindAsync(new UserLoginInfo(
